...
RUN dotnet restore csharp-compounding-docs.sln
...
HEALTHCHECK --interval=30s --timeout=10s --start-period=5s --retries=3 \
    CMD wget --no-verbose --tries=1 --spider http://localhost:${COMPOUNDDOCS_PORT:-3000}/health || exit 1
