...
public sealed class GitSyncService : IGitSyncService
{
    ...
    [ExcludeFromCodeCoverage(Justification = "Creates directories on filesystem; tested via internal constructor")]
    ...
    [ExcludeFromCodeCoverage(Justification = "Uses LibGit2Sharp static methods (Repository.IsValid, Repository.Clone, Commands.Pull)")]
    ...
    [ExcludeFromCodeCoverage(Justification = "Uses LibGit2Sharp static methods and Repository instances")]
    ...
    [ExcludeFromCodeCoverage(Justification = "Helper for GetChangedFilesAsync; requires real LibGit2Sharp Tree objects")]
