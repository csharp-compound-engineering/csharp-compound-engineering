...
public sealed class ChunkingStrategy
{
    ...
    /// </summary>
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage(Justification = "Infinite-loop guard (lines 254-257) is unreachable because Validate() prevents Overlap >= ChunkSize; remaining logic is tested via Chunk() integration tests")]
