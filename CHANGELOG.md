...
* **infra:** replace VPC endpoints with NAT gateway, remove logging, reduce AZs ([#77](https://github.com/csharp-compound-engineering/csharp-compound-engineering/issues/77)) ([d0a6516](https://github.com/csharp-compound-engineering/csharp-compound-engineering/commit/d0a65166922693d3345de34a990f4233b91fded7))

## [5.1.4](https://github.com/csharp-compound-engineering/csharp-compound-engineering/compare/v5.1.3...v5.1.4) (2026-03-16)

### Bug Fixes

* **ci:** add plugin manifest version stamping to release-prepare ([#76](https://github.com/csharp-compound-engineering/csharp-compound-engineering/issues/76)) ([e247a2c](https://github.com/csharp-compound-engineering/csharp-compound-engineering/commit/e247a2c97c3d375ff1375492ae7c663c803dac4a))

## [5.1.3](https://github.com/csharp-compound-engineering/csharp-compound-engineering/compare/v5.1.2...v5.1.3) (2026-03-16)

### Bug Fixes

* **infra:** set Neptune backup retention to minimum (1 day) ([#75](https://github.com/csharp-compound-engineering/csharp-compound-engineering/issues/75)) ([1dc02b7](https://github.com/csharp-compound-engineering/csharp-compound-engineering/commit/1dc02b761e59d3e1ac4e3a92323c6bcea028bfac))
...
* **infra:** resolve serverless deployment blockers for SG replacement, OpenSearch auth, and Lambda ZIP ([#73](https://github.com/csharp-compound-engineering/csharp-compound-engineering/issues/73)) ([444ab86](https://github.com/csharp-compound-engineering/csharp-compound-engineering/commit/444ab86e1fd63d180ede23cc23f39e26e26da509))

## [5.1.0](https://github.com/csharp-compound-engineering/csharp-compound-engineering/compare/v5.0.0...v5.1.0) (2026-03-12)

### Features

* **ci:** add lambda zip packaging to semantic-release pipeline ([2898f99](https://github.com/csharp-compound-engineering/csharp-compound-engineering/commit/2898f99fc752367ac2bd7eb6ffa2f2ac2bc1626a))
...
* **mcp:** replace JsonElement with Document type for Neptune openCypher responses ([#70](https://github.com/csharp-compound-engineering/csharp-compound-engineering/issues/70)) ([1bb7b2c](https://github.com/csharp-compound-engineering/csharp-compound-engineering/commit/1bb7b2c2ba6afa35c106017ac1cf4cc0fef0342c))

## [4.0.8](https://github.com/csharp-compound-engineering/csharp-compound-engineering/compare/v4.0.7...v4.0.8) (2026-03-06)

### Bug Fixes

* **infra:** target Neptune engine 1.4.6.3 (highest valid upgrade from 1.2.0.1) ([#69](https://github.com/csharp-compound-engineering/csharp-compound-engineering/issues/69)) ([4178ada](https://github.com/csharp-compound-engineering/csharp-compound-engineering/commit/4178ada7171e46ab097262da36eb380f4ed12c65))
...
* **mcp:** normalize OpenSearch/Neptune endpoint URIs and enhance connection logging ([#65](https://github.com/csharp-compound-engineering/csharp-compound-engineering/issues/65)) ([1480dbf](https://github.com/csharp-compound-engineering/csharp-compound-engineering/commit/1480dbfc1fd248fbd8f2395e61906c8c28fc9d61))

## [4.0.3](https://github.com/csharp-compound-engineering/csharp-compound-engineering/compare/v4.0.2...v4.0.3) (2026-03-06)

### Bug Fixes

* **infra:** add OpenSearch service-linked role to Crossplane workspace ([#64](https://github.com/csharp-compound-engineering/csharp-compound-engineering/issues/64)) ([a087e4a](https://github.com/csharp-compound-engineering/csharp-compound-engineering/commit/a087e4af2fa61c62e79fec6655db40b349b2686e))

## [4.0.2](https://github.com/csharp-compound-engineering/csharp-compound-engineering/compare/v4.0.1...v4.0.2) (2026-03-06)

### Bug Fixes

* **infra:** add master_user_arn to OpenSearch fine-grained access control ([#63](https://github.com/csharp-compound-engineering/csharp-compound-engineering/issues/63)) ([c28067d](https://github.com/csharp-compound-engineering/csharp-compound-engineering/commit/c28067d3f53d3cc6bda20cceaca28348e76d1351))

## [4.0.1](https://github.com/csharp-compound-engineering/csharp-compound-engineering/compare/v4.0.0...v4.0.1) (2026-03-02)

### Bug Fixes

* **mcp:** isolate health endpoint to pod-local management port ([#62](https://github.com/csharp-compound-engineering/csharp-compound-engineering/issues/62)) ([1e695cd](https://github.com/csharp-compound-engineering/csharp-compound-engineering/commit/1e695cd79288122013ddd5711547b5e87d6e4654))
