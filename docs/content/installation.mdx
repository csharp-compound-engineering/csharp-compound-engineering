...
git clone https://github.com/michaelmccord/csharp-compound-engineering.git
...
- [GitHub Issues](https://github.com/michaelmccord/csharp-compound-engineering/issues)
