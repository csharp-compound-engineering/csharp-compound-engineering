...
public class RagQueryToolTests
{
    ...
    {
        var ex = Should.Throw<ArgumentNullException>(() => new RagQueryTool(null!, _graphRepository.Object, _embeddingService.Object, _llmService.Object, _graphRagPipeline.Object, _logger));
        ex.ParamName.ShouldBe("vectorStore");

        ex = Should.Throw<ArgumentNullException>(() => new RagQueryTool(_vectorStore.Object, null!, _embeddingService.Object, _llmService.Object, _graphRagPipeline.Object, _logger));
        ex.ParamName.ShouldBe("graphRepository");

        ex = Should.Throw<ArgumentNullException>(() => new RagQueryTool(_vectorStore.Object, _graphRepository.Object, null!, _llmService.Object, _graphRagPipeline.Object, _logger));
        ex.ParamName.ShouldBe("embeddingService");

        ex = Should.Throw<ArgumentNullException>(() => new RagQueryTool(_vectorStore.Object, _graphRepository.Object, _embeddingService.Object, null!, _graphRagPipeline.Object, _logger));
        ex.ParamName.ShouldBe("llmService");

        ex = Should.Throw<ArgumentNullException>(() => new RagQueryTool(_vectorStore.Object, _graphRepository.Object, _embeddingService.Object, _llmService.Object, null!, _logger));
        ex.ParamName.ShouldBe("graphRagPipeline");

        ex = Should.Throw<ArgumentNullException>(() => new RagQueryTool(_vectorStore.Object, _graphRepository.Object, _embeddingService.Object, _llmService.Object, _graphRagPipeline.Object, null!));
