...
/// Direct NeptuneClient construction requires AWS SDK credentials; we test the graph
/// repository layer (which wraps INeptuneClient) in NeptuneClientTests instead.
/// </summary>
